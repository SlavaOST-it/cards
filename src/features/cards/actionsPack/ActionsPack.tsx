        ...
        <div className={s.actionBtn}>
            ...
            {myId === userId && (
                <>
                    ...
                    <DeletePackModal packId={packId} packName={packName} active={activeDeleteModal} setActive={onActiveModal}
                                    />
                    <EditPackModal name={packName} packId={packId} active={activeEditModal} setActive={onActiveEditModal}/>
